...
samplesDef = {
    ...
    'mcNom'  : tnpSamples.ReReco2018['DY_madgraph'].clone(),#bing
    'mcAlt'  : tnpSamples.ReReco2018['DY_powheg'].clone(),#bing
    'tagSel' : tnpSamples.ReReco2018['DY_madgraph'].clone(),#bing
}
...
if not samplesDef['mcNom' ] is None: samplesDef['mcNom' ].set_puTree('/eos/cms/store/group/phys_egamma/swmukher/rereco2018/ECAL_NOISE/DY_MG_pho.pu.puTree.root')#bing
if not samplesDef['mcAlt' ] is None: samplesDef['mcAlt' ].set_puTree('/eos/cms/store/group/phys_egamma/swmukher/rereco2018/ECAL_NOISE/DY_powheg_pho.pu.puTree.root')#bing
if not samplesDef['tagSel'] is None: samplesDef['tagSel'].set_puTree('/eos/cms/store/group/phys_egamma/swmukher/rereco2018/ECAL_NOISE/DY_MG_pho.pu.puTree.root')#bing
...
biningDef = [
   ...
   { 'var' : 'ph_et' , 'type': 'float', 'bins': [10,15,20,35,50] }, #bing
]
