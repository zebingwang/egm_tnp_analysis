...
#ALPPreselection = neuiso_rhocorr_1

#ALPPreselection = '( (ph_abseta < 1.4442 && ph_abseta<1. && TMath::Max(0.0, ph_chIso - event_rho * 0.0112) < 0.65 && TMath::Max(0.0, ph_neuIso - event_rho * 0.0668) < 0.317 + ph_et*0.01512 + ph_et*ph_et*0.00002259 && ph_hoe < 0.02148 )||(ph_abseta < 1.4442 && ph_abseta>1. && ph_abseta<1.4790 && TMath::Max(0.0, ph_chIso - event_rho * 0.0108) < 0.65 && TMath::Max(0.0, ph_neuIso - event_rho * 0.1054) < 0.317 + ph_et*0.01512 + ph_et*ph_et*0.00002259 && ph_hoe < 0.02148 )||(ph_abseta > 1.566 && ph_abseta < 2.5 && ph_abseta>1.4790 && ph_abseta<2. && TMath::Max(0.0, ph_chIso - event_rho * 0.0106) < 0.517 && TMath::Max(0.0, ph_neuIso - event_rho * 0.0786) < 2.716 + ph_et*0.0117 + ph_et*ph_et*0.000023 && ph_hoe < 0.0321 )||(ph_abseta > 1.566 && ph_abseta < 2.5 && ph_abseta>2.0 && ph_abseta<2.2 && TMath::Max(0.0, ph_chIso - event_rho * 0.01002) < 0.517 && TMath::Max(0.0, ph_neuIso - event_rho * 0.0233) < 2.716 + ph_et*0.0117 + ph_et*ph_et*0.000023 && ph_hoe < 0.0321 )||(ph_abseta > 1.566 && ph_abseta < 2.5 && ph_abseta>2.2 && ph_abseta<2.3 && TMath::Max(0.0, ph_chIso - event_rho * 0.0098) < 0.517 && TMath::Max(0.0, ph_neuIso - event_rho * 0.0078) < 2.716 + ph_et*0.0117 + ph_et*ph_et*0.000023 && ph_hoe < 0.0321 )||(ph_abseta > 1.566 && ph_abseta < 2.5 && ph_abseta>2.3 && ph_abseta<2.4 && TMath::Max(0.0, ph_chIso - event_rho * 0.0089) < 0.517 && TMath::Max(0.0, ph_neuIso - event_rho * 0.0028) < 2.716 + ph_et*0.0117 + ph_et*ph_et*0.000023 && ph_hoe < 0.0321 )||(ph_abseta > 1.566 && ph_abseta < 2.5 && ph_abseta>2.4 && ph_abseta<5.0 && TMath::Max(0.0, ph_chIso - event_rho * 0.0087) < 0.517 && TMath::Max(0.0, ph_neuIso - event_rho * 0.0137) < 2.716 + ph_et*0.0117 + ph_et*ph_et*0.000023 && ph_hoe < 0.0321 ) )'
...
#if not samplesDef['mcNom' ] is None: samplesDef['mcNom' ].set_puTree('/eos/cms/store/group/phys_egamma/swmukher/ntuple_2017_v2/PU/MiniAOD_17Nov2017Rereco/May17_2020/DY_madgraph_pho.pu.puTree.root')#bing
#if not samplesDef['mcAlt' ] is None: samplesDef['mcAlt' ].set_puTree('/eos/cms/store/group/phys_egamma/swmukher/ntuple_2017_v2/PU/MiniAOD_17Nov2017Rereco/May17_2020/DY_madgraph_pho.pu.puTree.root')#bing
#if not samplesDef['tagSel'] is None: samplesDef['tagSel'].set_puTree('/eos/cms/store/group/phys_egamma/swmukher/ntuple_2017_v2/PU/MiniAOD_17Nov2017Rereco/May17_2020/DY_madgraph_pho.pu.puTree.root')#bing
