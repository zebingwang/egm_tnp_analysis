...
chiso_eff = [0.0360, 0.0377, 0.0306, 0.0283, 0.0254, 0.0217, 0.0167]
chCut_EB = 0.202
chCut_EE = 0.034
chisoCut = '%f'
...
neuiso_eff = [0.0597, 0.0807, 0.0629, 0.0197, 0.0184, 0.0284, 0.0591]
...
flags = {
    ...
    'passALPPreselection' : ALPPreselection,
    }
